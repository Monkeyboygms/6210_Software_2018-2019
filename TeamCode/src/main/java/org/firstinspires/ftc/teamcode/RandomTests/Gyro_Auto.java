...
public class Gyro_Auto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        gyroDrive( DRIVE_SPEED, -12.0, -30.0); // Reverse BWD 12 inches at -30 Degrees
        gyroTurn( TURN_SPEED, 90.0);        // Turn CW to 90 Degrees
        gyroHold( TURN_SPEED, 90.0, 0.5);   // Hold 90 Deg heading for 1/2 second
        gyroDrive( DRIVE_SPEED, 24.0, 90.0);    // Drive FWD 24 inches at 90 degrees
